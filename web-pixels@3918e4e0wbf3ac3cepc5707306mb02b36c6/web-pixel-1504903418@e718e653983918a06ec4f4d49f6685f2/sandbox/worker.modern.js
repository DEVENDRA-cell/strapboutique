(() => {
            ...
            1639: (e, t, r) => {
                ...
                e.exports = function(e, t, r) {
                    var m, v, w, g, y, x, S, k = r && r.that,
                        ...
                        T = function(e) {
                            return O ? (i(e), A ? j(e[0], e[1], I) : j(e[0], e[1])) : A ? j(e, I) : j(e)
                        };
                    if (E) m = e.iterator;
                    else if (R) m = e;
                    else {
    ...
    r.amdO = {}, r.n = e => {
        ...
        const h = "production",
            m = "3918e4e0wbf3ac3cepc5707306mb02b36c6",
            v = "s3918e4e0wbf3ac3cepc5707306mb02b36c6m.js";
        ...
        const R = (e, t) => {
                ...
                const n = function(e, t) {
                    ...
                    try {
                        if (o) {
                            ...
                            if (t && t.length > 2 && (n.lineNumber = t[1], n.columnNumber = t[2], parseInt(n.lineNumber, 10) > 1e5)) throw new E
                        }
                        return {
                            errorClass: e ? .name || r,
                            message: e ? .message || r,
            ...
            A = ["number", "boolean", "symbol"],
            j = (e, {
                context: t
            }) => {
                const r = "v1/" + (t ? `${t}/` : "");
                return null == e || A.includes(typeof e) || Array.isArray(e) ? `${r}UnknownError` : "string" == typeof e ? `${r}${e}` : "groupingHash" in e && "string" == typeof e.groupingHash ? `${r}${e.groupingHash}` : `${r}${"Error"!==e.name&&e.name?e.name:e.message}`
            };
        Error;
        const I = {
                severity: "error",
                ...
                notify: (e, t) => {
                    try {
                        ...
                        if (t ? .options ? .sampleRate && ! function(e) {
                                if (e <= 0 || e > 100) throw new g("Invalid sampling percent", {
                        ...
                        if (r.browserTarget === x.NotAvailable || r.browserTarget === x.Unknown || r.surface === y.NotAvailable || r.surface === y.Unknown || !N(r.shopUrl)) return void(console ? .error && console.error(e));
                        const n = function(e, t) {
                            const {
                                userAgent: r,
                                context: n,
        ...
        const C = e => "number" == typeof e ? new D(e) : new Map,
        ...
        function z(e) {
            ...
            function({
                ...
                const r = B(t, e.browser.localStorage);
            ...
            function({
                ...
                const r = B(t, e.browser.sessionStorage);
        ...
        const W = new URL(self.location.href);
        class $ extends Error {
            constructor(...e) {
        ...
        function V(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol) throw new $(`URL must be secure (HTTPS): ${t.href}`);
            if (/^\/api\/.+\/graphql\.json$/.test(t.pathname)) return t;
            const r = W.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${W.protocol}//(.*@)?${r}`, "i").test(t.href)) throw new q(`Requests are not allowed to the same origin: ${t.href}`);
            return t
        }
        const G = Function.prototype.call.bind(XMLHttpRequest.prototype.open);
        r(2341), r(7872);
        const H = ["constructor", "hasOwnProperty", "toString", "toLocaleString", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "__defineGetter__", "__defineSetter__", "__lookupGetter__", "__lookupSetter__", "__proto__", "apply", "call", "bind"];

        function X(e, t) {
            if (Object.prototype.hasOwnProperty.call(e, t)) return e;
            const r = Object.getPrototypeOf(e);
            return r ? X(r, t) : void 0
        }
        ...
        function Y(e, t, r) {
            try {
                ...
                if (Array.isArray(r)) {
                    const [n, i] = r;
                    "function" == typeof o && (o = e[t]), K(o, function(e) {
                        const t = new Set;
                        let r = e;
                        for (; r;) Object.getOwnPropertyNames(r).forEach((e => {
                            H.includes(e) || t.add(e)
        ...
        Object.defineProperty(self, "webPixelsManager", {
            value: {
                createShopifyExtend: () => ({
                    extend: async (e, t) => {
                        if ("WebPixel::Render" !== e) throw new Q;
                        ne = t
                    }
                })
            },
        ...
        const ie = async e => {
            ...
            if (oe) {
                ...
                throw T.notify(e, {
                    ...
                    sandboxUrl: W.href || "unknown"
                }), e
            }
            oe = !0, a(o);
            try {
                te && (o.browser.sendBeacon = P), te || (z(e), self.document.title = t)
            } catch (s) {
                throw T.notify(s, {
                    pixelId: r.id,
                    pixelType: r.type,
        ...
        (() => {
            try {
                ...
                }(t.addEventListener)), K(t, r), Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), Object.freeze(RegExp.prototype), _(self, "String", {
                    writable: !1,
                    configurable: !1
                }), _(self, "Request", {
                    writable: !1,
...
globalThis.shopify = self.webPixelsManager.createShopifyExtend('1504903418', 'APP');
importScripts('/web-pixels/strict/app/web-pixel-1504903418@e718e653983918a06ec4f4d49f6685f2.js');