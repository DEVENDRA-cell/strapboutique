import {
    ...
    z as S,
    B as z
} from "./chunk.common_C4Q8P6sY.esm.js";
const I = Math.min,
    F = Math.max,
    H = Math.round,
    j = Math.floor,
...
function Le(e) {
    ...
    let l = (i ? H(n.width) : n.width) / o,
        s = (i ? H(n.height) : n.height) / r;
...
function De(e, t, n) {
    ...
    return {
        x: o.left + t.scrollLeft - (n ? 0 : Ce(e, o)),
        y: o.top + t.scrollTop
    }
}
...
function Pe(e, t, n) {
    ...
    if ("viewport" === t) o = function(e, t) {
        ...
        let l = -n.scrollLeft + Ce(e);
        const s = -n.scrollTop;
        return "rtl" === ye(o).direction && (l += F(t.clientWidth, o.clientWidth) - r), {
            width: r,
            height: i,
            x: l,
            y: s
...
function ke(e, t) {
    const n = we(e);
    return !(n === t || !ae(n) || ge(n)) && ("fixed" === ye(n).position || ke(n, t))
}
...
function ze(e, t) {
    if (!ce(e) || "fixed" === ye(e).position) return null;
    if (t) return t(e);
...
function Ie(e, t) {
    ...
    if (!ce(e)) {
        let t = we(e);
        for (; t && !ge(t);) {
            if (ae(t) && !Se(t)) return t;
            t = we(t)
        }
        return n
    }
    let o = ze(e, t);
    for (; o && fe(o) && Se(o);) o = ze(o, t);
    return o && ge(o) && Se(o) && !pe(o) ? n : o || function(e) {
        let t = we(e);
        for (; ce(t) && !ge(t);) {
            if (pe(t)) return t;
            if (me(t)) return null;
...
const Fe = {
    convertOffsetParentRelativeRectToViewportRelativeRect: function(e) {
        ...
        const u = N(0),
            d = ce(o);
        if ((d || !d && !i) && (("body" !== re(o) || de(l)) && (a = ve(o)), ce(o))) {
            const e = Me(o);
...
function je(e, t, n, o) {
    ...
    const d = c && s ? function(e, t) {
        ...
        return function l(s, a) {
            ...
            if (s || t(), !f || !m) return;
            const p = {
                rootMargin: -j(d) + "px " + -j(r.clientWidth - (u + f)) + "px " + -j(r.clientHeight - (d + m)) + "px " + -j(u) + "px",
            ...
            function g(t) {
                ...
                1 !== o || He(c, e.getBoundingClientRect()) || l(), h = !1
            }
            try {
        ...
        return void 0 === e && (e = {}), {
            ...
            async fn(t) {
                ...
                if (O = [...O, {
                    ...
                    let n = null == (M = O.filter((e => e.overflows[0] <= 0)).sort(((e, t) => e.overflows[1] - t.overflows[1]))[0]) ? void 0 : M.placement;
                    if (!n) switch (m) {
                        case "bestFit":
                            {
                                var C;
                                const e = null == (C = O.filter((e => {
                                    if (T) {
                                        const t = Z(e.placement);
                                        return t === v || "y" === t
                                    }
                                    return !0
                                })).map((e => [e.placement, e.overflows.filter((e => e > 0)).reduce(((e, t) => e + t), 0)])).sort(((e, t) => e[1] - t[1]))[0]) ? void 0 : C[0];e && (n = e);
                                break
                            }
    ...
    Be = e => ({
        ...
        async fn(t) {
            ...
            const R = x / 2 - b / 2,
                ...
                D = E / 2 - h[p] / 2 + R,
                P = B(M, D, C),
                k = !a.arrow && null != U(r) && D !== P && i.reference[p] / 2 - (D < M ? O : _) - h[p] / 2 < 0,
                A = k ? D < M ? D - M : D - C : 0;
            return {
                [m]: f[m] + A,
                data: {
...
const Ye = ["right", "left", "bottom", "top"],
    Ze = ({
        ...
        const {
            dispatch: z,
            modalDismissible: I
        } = s(), F = t(null), [H, j] = o(null), N = t(null), V = t(null), W = t(null), [B, q] = o(!1), {
            instanceId: $
        } = a(), U = t(null), {
            floatingStyles: X,
            middlewareData: Y,
            ...
            const [x, b] = o(null), [T, E] = o(null), R = i((e => {
                ...
                e !== C.current && (C.current = e, E(e))
            }), []), O = d || x, _ = f || T, M = t(null), C = t(null), D = t(g), P = null != p, k = Xe(p), A = Xe(u), S = i((() => {
                ...
                A.current && (e.platform = A.current), qe(M.current, C.current, e).then((e => {
                    const t = Object.assign(Object.assign({}, e), {
                        isPositioned: !0
                    });
                    z.current && !r(D.current, t) && (D.current = t, y(t))
                })).catch((e => {
                    console.error("error caught during computePosition", e)
                }))
            }), [v, s, a, A]);
            n((() => {
                !1 === h && D.current.isPositioned && (D.current.isPositioned = !1, y((e => Object.assign(Object.assign({}, e), {
                    isPositioned: !1
                }))))
            }), [h]);
            const z = t(!1);
            n((() => (z.current = !0, () => {
                ...
                if (O && (M.current = O), _ && (C.current = _), O && _) {
                    if (k.current) return k.current(O, _, S);
                    S()
                }
            }), [O, _, S, k, P]);
            const I = l((() => ({
        ...
        n((() => {
            if (v) {
                let e;
                e = "string" == typeof v ? c.querySelector(v) : v.current, j(e), Z.setReference(e), G()
            }
        }), [v, Z, G]), null === U.current && (U.current = c.documentElement.style.overflow), !V.current && u() && (V.current = new IntersectionObserver((t => {
            for (const n of t) {
            ...
            for (const o of t) {
                if (o.boundingClientRect.top < 0 && e.scrollTo({
                    ...
                    const t = ((null == H ? void 0 : H.offsetHeight) || 0) + ((null === (n = W.current) || void 0 === n ? void 0 : n.offsetHeight) || 0) / 2 + 30;
                    e.scrollTo({
        ...
        const {
            isDesktop: K
        } = d(), Q = l((() => H && !M && K ? "dynamic" : "center"), [H, K, M]);
        n((() => {
        ...
        n((() => {
            ...
            P ? (c.documentElement.style.overflow = "hidden", V.current && W.current && V.current.observe(W.current), F.current && H && F.current.observe(H)) : (V.current && W.current && V.current.unobserve(W.current), F.current && H && F.current.unobserve(H), c.documentElement.style.overflow = U.current || "")
        }), [H, ee, P]), n((() => {
            var e;
        ...
        let oe = "";
        "checkoutModal" === D && (oe = "wide" === C ? "max-w-100 sm_max-w-none" : "max-w-85 sm_max-w-none");
        const re = f("relative z-50 bg-white transition duration-400 ease-cubic-modal will-change-transform focus_outline-none focus_outline-0 motion-reduce_duration-0 sm_absolute sm_inset-x-0 sm_bottom-0 sm_top-auto sm_rounded-b-none", P ? "opacity-100 sm_translate-y-0" : "opacity-0 sm_translate-y-full", "dynamic" === Q && P ? "scale-100" : "", "dynamic" !== Q || P ? "" : "scale-0 sm_scale-100", !E && ("wide" === C ? "min-w-100" : "min-w-85"), oe, !T && "rounded-xxl", !K && "max-h-full"),
            ie = l((() => {
                if (K) return {};
            ...
            }), [null === (k = Y.arrow) || void 0 === k ? void 0 : k.x, null === (A = Y.arrow) || void 0 === A ? void 0 : A.y, null === (S = Y.flip) || void 0 === S ? void 0 : S.overflows, Q]),
        ...
        return p(m(y, {
            ...
            children: m("div", {
                ...
                children: [m("div", Object.assign({}, ue, {
                    ...
                    part: "modal",
                    ref: e => {
                        W.current = e, H && (Z.setFloating(e), G())
                    },
                    role: "dialog",
                    style: ce,
                    children: [m("div", {
        ...
        }), [B]),
        {
            ...
            onError: e => {
                ...
                et(n, t) ? (J("authorize error", {
                    code: n,
                    message: t
                }, "state"), K(new A(t, "AuthorizeError"))) : (re("shop_js_handle_silent_error", {
                    attributes: {
                        errorCode: n
                    }
                }), J("silent error", {
...
//# sourceMappingURL=chunk.modal_D5uMbf6W.esm.js.map