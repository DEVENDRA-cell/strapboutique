var themeVendor = function(t) {
    ...
    s = l,
        ...
        }("undefined" != typeof window ? window : i, (function() {
            function t() {}
            let e = t.prototype;
    ...
    ! function(t) {
        ! function(e, i) {
            ...
            return function(i) {
                ...
                let f = t(n.height);
                return !1 !== f && (s.height = f + (o ? 0 : l + d)), s.innerWidth = s.width - (r + c), s.innerHeight = s.height - (l + d), s.outerWidth = s.width + a, s.outerHeight = s.height + h, s
            }
        }))
    }(a);
    var h = {
    ...
    ! function(t) {
        ! function(e, i) {
            ...
            let e = {
                ...
                i = t.console;
            return e.htmlInit = function(n, s) {
                e.docReady((function() {
                    let o = "data-" + e.toDashed(s),
                        r = document.querySelectorAll(`[${o}]`),
                        l = t.jQuery;
                    [...r].forEach((t => {
                        let e, r = t.getAttribute(o);
                        try {
                            e = r && JSON.parse(r)
                        } catch (e) {
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(a.exports) : (e.Flickity = e.Flickity || {}, e.Flickity.Cell = i(e.getSize))
        }("undefined" != typeof window ? window : i, (function(t) {
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(h.exports) : (e.Flickity = e.Flickity || {}, e.Flickity.animatePrototype = i(e.fizzyUIUtils))
        }("undefined" != typeof window ? window : i, (function(t) {
            let e = {
    ...
    function(t) {
        ! function(e, i) {
            if (t.exports) t.exports = i(e, l.exports, a.exports, h.exports, c.exports, d.exports, u.exports);
            else {
                let t = e.Flickity;
                e.Flickity = i(e, e.EvEmitter, e.getSize, e.fizzyUIUtils, t.Cell, t.Slide, t.animatePrototype)
            }
        }("undefined" != typeof window ? window : i, (function(t, e, i, n, s, o, r) {
            const {
                getComputedStyle: l,
                console: a
            } = t;
            ...
            function u(t, e) {
                ...
                if (i) {
                    ...
                    h && (this.$element = h(this.element)), this.options = { ...this.constructor.defaults
            ...
            Object.assign(f, e.prototype), f._create = function() {
                ...
                let {
                    beginMargin: t,
                    endMargin: e
                } = this, i = new o(t, e, this.cellAlign);
                this.slides.push(i);
            ...
            f.emitEvent = function(t, e) {
                ...
                this.selectedIndex = t, this.updateSelectedSlide(), i ? this.positionSliderAtSelected() : this.startAnimation(), this.options.adaptiveHeight && this.setGallerySize(), this.dispatchEvent("select", null, [t]), t !== s && this.dispatchEvent("change", null, [t])
            ...
            }, n.debounceMethod(u, "onresize", 150), f.resize = function() {
                ...
                let {
                    activeElement: e
                } = document, i = u.keyboardHandlers[t.key];
            ...
            }, Object.assign(f, r), u.data = function(t) {
                if (t = n.getQueryElement(t)) return d[t.flickityGUID]
            }, n.htmlInit(u, "flickity");
            let {
                jQueryBridget: v
            } = t;
            return h && v && v("flickity", u, h), u.setJQuery = function(t) {
                h = t
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(e, l.exports) : e.Unidragger = i(e, e.EvEmitter)
        }("undefined" != typeof window ? window : i, (function(t, e) {
            function i() {}
            let n, s, o = i.prototype = Object.create(e.prototype);
            o.handleEvent = function(t) {
                let e = "on" + t.type;
                this[e] && this[e](t)
            }, "ontouchstart" in t ? (n = "touchstart", s = ["touchmove", "touchend", "touchcancel"]) : t.PointerEvent ? (n = "pointerdown", s = ["pointermove", "pointerup", "pointercancel"]) : (n = "mousedown", s = ["mousemove", "mouseup"]), o.touchActionValue = "none", o.bindHandles = function() {
            ...
            return o.pointerDown = function(t, e) {
                let i = r.includes(t.target.nodeName),
                    ...
                    s = !i || n;
                !this.isPointerDown && !t.button && s && (this.isPointerDown = !0, this.pointerIdentifier = void 0 !== e.pointerId ? e.pointerId : e.identifier, this.pointerDownPointer = {
                    pageX: e.pageX,
                    pageY: e.pageY
    ...
    function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(e, r.exports, f.exports, h.exports) : e.Flickity = i(e, e.Flickity, e.Unidragger, e.fizzyUIUtils)
        }("undefined" != typeof window ? window : i, (function(t, e, i, n) {
            ...
            return Object.assign(s, i.prototype), s.touchActionValue = "", e.create.drag = function() {
                ...
                i || n || s || e.preventDefault(), s || this.focus(), document.activeElement !== this.element && document.activeElement.blur(), this.dragX = this.x, this.viewport.classList.add("is-pointer-down"), this.pointerDownScroll = o(), t.addEventListener("scroll", this), this.bindActivePointerEvents(e)
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(r.exports) : i(e.Flickity)
        }("undefined" != typeof window ? window : i, (function(t) {
            ...
            i.prototype._create = function(t) {
                ...
                let {
                    rightToLeft: t,
                    arrowShape: e
                } = this.options, n = t ? "right" : "left", s = t ? "left" : "right";
                this.prevButton = new i("previous", n, e), this.nextButton = new i("next", s, e), this.focusableElems.push(this.prevButton.element), this.focusableElems.push(this.nextButton.element), this.handlePrevButtonClick = () => {
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(r.exports, h.exports) : i(e.Flickity, e.fizzyUIUtils)
        }("undefined" != typeof window ? window : i, (function(t, e) {
            function i() {
    ...
    ! function(t) {
        ! function(e, i) {
            ...
            return r.lazyLoad = function() {
                let {
                    lazyLoad: t
                } = this.options;
                if (!t) return;
                let e = "number" == typeof t ? t : 0;
                this.getAdjacentCellElements(e).map(l).flat().forEach((t => new a(t, this.handleLazyLoadComplete)))
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(e, l.exports) : e.imagesLoaded = i(e, e.EvEmitter)
        }("undefined" != typeof window ? window : i, (function(t, e) {
            let i = t.jQuery,
                n = t.console;
            ...
            function s(t, e, o) {
                ...
                let r = t;
                var l;
                ("string" == typeof t && (r = document.querySelectorAll(t)), r) ? (this.elements = (l = r, Array.isArray(l) ? l : "object" == typeof l && "number" == typeof l.length ? [...l] : [l]), this.options = {}, "function" == typeof e ? o = e : Object.assign(this.options, e), o && this.on("always", o), this.getImages(), i && (this.jqDeferred = new i.Deferred), setTimeout(this.check.bind(this))) : n.error(`Bad element for imagesLoaded ${r||t}`)
            }
            ...
            }, a.prototype = Object.create(l.prototype), a.prototype.check = function() {
    ...
    function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(r.exports, p.exports) : i(e.Flickity, e.imagesLoaded)
        }("undefined" != typeof window ? window : i, (function(t, e) {
    ...
    ! function(t) {
        ! function(e, i) {
            t.exports ? t.exports = i(o.exports, h.exports) : i(e.Flickity, e.fizzyUIUtils)
        }("undefined" != typeof window ? window : i, (function(t, e) {
            let i = t.Slide;
            i.prototype.renderFadePosition = function() {}, i.prototype.setOpacity = function(t) {
            ...
            n.updateSlides = function() {
                s.apply(this, arguments), this.options.fade && this.slides.forEach(((t, e) => {
                    let i = t.target - t.x,
                        n = t.cells[0].x;
                    t.cells.forEach((t => {
                        let e = t.x - n - i;
                ...
                this.selectedSlide.setOpacity(1), this.slides[this.fadeIndex] && this.fadeIndex !== this.selectedIndex && this.slides[this.fadeIndex].setOpacity(0)
            }, n.onDragEndFade = function() {
                this.didDragEnd = !0
            }, n.onActivateFade = function() {
                this.options.fade && this.element.classList.add("is-fade")
            }, n.onDeactivateFade = function() {
                this.options.fade && (this.element.classList.remove("is-fade"), this.slides.forEach((t => {
                    t.setOpacity("")
                })))
            };
            ...
            return function(t) {
                ...
                var n = function(t) {
                    ...
                    h = function(t, e) {
                        ...
                        for (;
                            (t = t.parentElement) && -1 === a(n.querySelectorAll(e)).indexOf(t););
                        return t
                    },
                    c = function(t, e) {
                ...
                var b = ["padding", "margin", "width", "max-width", "none"],
                    ...
                    S = function(t) {
                        x.queue <= 0 && (x.scroll = !1, G(), X()), P(t), x.queue++
                    },
                    w = function(t) {
                        x.queue > 0 && x.queue--, x.queue <= 0 && (x.scroll = !0, U(), Y()), I(t)
                    },
                    E = function() {
                        return x.scroll
                    },
                    ...
                    k = function(t) {
                        ...
                        if (s(t)) {
                            ...
                            e ? E() || (t.style.overflowY = t.getAttribute("data-scroll-lock-saved-overflow-y-property")) : t.style.overflowY = "scroll";
                            var n = D(t);
                    ...
                    W = function(t) {
                        t && n(t).map((function(t) {
                            x.scrollableSelectors.push(t)
                        }))
                    },
                    F = function(t) {
                        t && n(t).map((function(t) {
                            x.scrollableSelectors = x.scrollableSelectors.filter((function(e) {
                                return e !== t
                            }))
                        }))
                    },
                    ...
                    T = function(t) {
                        t && (n(t).map((function(t) {
                            x.lockableSelectors.push(t)
                        })), E() || G(), B(t))
                    },
                    M = function(t) {
                        if (t)
                            if (-1 !== b.indexOf(t)) x.fillGapMethod = t, j();
                            else {
                                var e = b.join(", ");
                    ...
                    _ = function(t) {
                        t && n(t).map((function(t) {
                            o(t, (function(t) {
                                s(t) ? (t.setAttribute("data-scroll-lock-fill-gap", ""), x.scroll || V(t)) : r('"'.concat(t, '" is not a Element.'))
                            }))
                        }))
                    },
                    O = function(t) {
                        t && n(t).map((function(t) {
                            o(t, (function(t) {
                                s(t) ? (t.removeAttribute("data-scroll-lock-fill-gap"), x.scroll || J(t)) : r('"'.concat(t, '" is not a Element.'))
                            }))
                        }))
                    },
                    B = function(t) {
                        t && n(t).map((function(t) {
                            -1 === x.fillGapSelectors.indexOf(t) && (x.fillGapSelectors.push(t), x.scroll || Q(t))
                        }))
                    },
                    N = function(t) {
                        t && n(t).map((function(t) {
                            x.fillGapSelectors = x.fillGapSelectors.filter((function(e) {
                                return e !== t
                            })), x.scroll || K(t)
                        }))
                    },
                    ...
                    X = function() {
                        x.fillGapSelectors.map((function(t) {
                            Q(t)
                        }))
                    },
                    Y = function() {
                    ...
                    Q = function(t) {
                        var e = document.querySelectorAll(t),
                            i = -1 !== x.lockableSelectors.indexOf(t);
                        o(e, (function(t) {
                            V(t, i)
                        }))
                    },
                    V = function(t) {
                        ...
                        if (s(t)) {
                            ...
                            if ("" === t.getAttribute("data-scroll-lock-lockable") || e) i = k(t, !0);
                                ...
                                var n = h(t, l(x.lockableSelectors));
                                i = k(n, !0)
                            }
                            "true" === t.getAttribute("data-scroll-lock-filled-gap") && J(t);
                            var o = window.getComputedStyle(t);
                            if (t.setAttribute("data-scroll-lock-filled-gap", "true"), t.setAttribute("data-scroll-lock-current-fill-gap-method", x.fillGapMethod), "margin" === x.fillGapMethod) {
                                var r = parseFloat(o.marginRight);
                                t.style.marginRight = "".concat(r + i, "px")
                            } else if ("width" === x.fillGapMethod) t.style.width = "calc(100% - ".concat(i, "px)");
                            else if ("max-width" === x.fillGapMethod) t.style.maxWidth = "calc(100% - ".concat(i, "px)");
                            else if ("padding" === x.fillGapMethod) {
                ...
                "undefined" != typeof window && window.addEventListener("resize", (function(t) {
                    ...
                    x.scroll || (x.startTouchY = t.touches[0].clientY, x.startTouchX = t.touches[0].clientX)
                        ...
                        if (t.touches.length < 2) {
                            ...
                            ! function e(i) {
                                ...
                                if (i) {
                                    var s = h(i, o, !1);
                                    if (v(i)) return !1;
                                    if (n || m(i) && h(i, o) || c(i, o)) {
                                        var l = !1;
                                        p(i) && g(i) ? (r.up && u(i) || r.down && f(i)) && (l = !0) : u(i) && f(i) ? (r.left && p(i) || r.right && g(i)) && (l = !0) : (a.up && u(i) || a.down && f(i) || a.left && p(i) || a.right && g(i)) && (l = !0), l && (s ? e(s, !0) : t.cancelable && t.preventDefault())
                                    } else e(s)
                    ...
                    x.scroll || (x.startTouchY = 0, x.startTouchX = 0)
                })));
                var Z = {
                        hide: function(t) {
                            r('"hide" is deprecated! Use "disablePageScroll" instead. \n https://github.com/FL3NKEY/scroll-lock#disablepagescrollscrollabletarget'), S(t)
                        },
                        show: function(t) {
                        ...
                        toggle: function(t) {
                            r('"toggle" is deprecated! Do not use it.'), E() ? S() : w(t)
                        },
                        getState: function() {
                    ...
                    tt = function(t) {
                        ...
                        getCurrentTargetScrollBarWidth: D,
                        ...
                        removeScrollableTarget: I,
                        addLockableSelector: T,
                        addLockableTarget: z,
    ...
    return window.theme.Flickity = g, window.theme.FlickityFade = v, t.ScrollLock = b, Object.defineProperty(t, "__esModule", {
        value: !0
    }), t
}({});